...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <style>
        ...
        .jumbotron {
            background-image: url('https://trungnguyenlegendcafe.net/wp-content/uploads/2023/11/app-1600x800px-1-scaled.jpg'); /* Thay thế bằng đường dẫn đến ảnh của bạn */
            background-size: cover;
            background-position: center;

            padding: 13rem 5rem; /* Tăng khoảng cách padding để hiển thị ảnh lớn hơn */
        ...
        .btn-feedback:hover {
            ...
            color: #6c5309; /* Màu chữ khi hover */
            background-color: transparent; /* Màu nền khi hover */
            border-color: #fff; /* Màu viền khi hover */
        }
